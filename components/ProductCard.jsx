  ...
  return (
    <div className="product-card group flex flex-col overflow-hidden rounded-3xl border-2 border-indigo-100/60 bg-gradient-to-br from-white to-indigo-50/30 shadow-md shadow-indigo-100/30 transition-all duration-300 hover:-translate-y-1.5 hover:border-indigo-300/80 hover:shadow-xl hover:shadow-indigo-200/40">
      ...
      <div className="product-content flex flex-1 flex-col gap-2 p-4">
        ...
        {/* Actions */}
        <div className="product-actions mt-auto flex items-center justify-between gap-3 pt-3 border-t-2 border-indigo-100/40">
          <span className="product-price rounded-2xl bg-gradient-to-r from-indigo-100/80 to-purple-100/80 px-3.5 py-1.5 text-sm font-extrabold text-indigo-700 shadow-sm shadow-indigo-100/30">
          ...
          {!inCart ? (
            <button
              type="button"
              onClick={handleAdd}
              className="product-add-btn rounded-2xl bg-gradient-to-r from-indigo-600 to-purple-600 px-4 py-2 text-xs font-bold text-white shadow-md shadow-indigo-200/50 transition-all duration-200 hover:shadow-lg hover:shadow-indigo-300/50 hover:scale-105 active:scale-95"
            >
              Add to Cart
            </button>
          ) : (
            <div className="product-qty-controls flex items-center gap-1.5 rounded-2xl border-2 border-indigo-200/60 bg-gradient-to-r from-indigo-50/80 to-purple-50/80 px-1.5 py-1.5 shadow-sm shadow-indigo-100/30">
              <button
                type="button"
