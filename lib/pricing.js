// Automatic, percentage-based discounts that kick in once the basket
// subtotal crosses a threshold. Checked from highest to lowest.
...
// Promo codes a shopper can type in. `type` is "percent" or "flat".
...
/**
 * Work out the full price breakdown for a subtotal + optional coupon.
 * The shopper gets whichever percentage is better (automatic tier or
 * coupon), plus any flat coupon amount stacked on top.
 */
